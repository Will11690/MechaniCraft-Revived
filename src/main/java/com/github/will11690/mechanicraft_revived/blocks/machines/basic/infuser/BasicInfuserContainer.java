...
public class BasicInfuserContainer extends AbstractContainerMenu {

    public final BasicInfuserBlockEntity infuserBE;
    private final Level level;

    public BasicInfuserContainer(int containerID, Inventory inv, FriendlyByteBuf extraData) {

        this(containerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public BasicInfuserContainer(int pContainerId, Inventory inv, BlockEntity entity) {

        super(MechaniCraftContainers.BasicInfuserCont.get(), pContainerId);
        checkContainerSize(inv, 4);
        infuserBE = (BasicInfuserBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        ...
        return stillValid(ContainerLevelAccess.create(level, infuserBE.getBlockPos()), player, MechaniCraftBlocks.BasicInfuser.get());
    }
