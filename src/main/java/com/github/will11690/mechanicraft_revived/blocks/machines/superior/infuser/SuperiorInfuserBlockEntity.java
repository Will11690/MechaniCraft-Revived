...
public class SuperiorInfuserBlockEntity extends BaseMachineBlockEntity implements IInfuserSync {

    private static final int BASE_CAPACITY = 307_200;
    private static final int BASE_TRANSFER = 1024;
    private static final int FE_PER_TICK = 128;
    ...
    public SuperiorInfuserBlockEntity(BlockPos pos, BlockState state) {

        // 3 upgrade slots: Speed/Efficiency/Capacity/Transfer unified
        super(MechaniCraftBlockEntities.SuperiorInfuserBE.get(), pos, state, true, BASE_CAPACITY, BASE_TRANSFER, true, 3);
    ...
    public void tickServer() {
        ...
        boolean wasLit = getBlockState().getValue(SuperiorInfuser.LIT);
        ...
        if (wasLit != workingThisTick) {
            ...
            level.setBlockAndUpdate(worldPosition, getBlockState().setValue(SuperiorInfuser.LIT, workingThisTick));
        }
    ...
    public @NotNull Component getDisplayName() {
        ...
        return MechaniCraftBlocks.SuperiorInfuser.get().getName();
    }

    @Override
    public @Nullable AbstractContainerMenu createMenu(int id, @NotNull Inventory inv, @NotNull Player player) {

        return new SuperiorInfuserContainer(id, inv, this);
    }
