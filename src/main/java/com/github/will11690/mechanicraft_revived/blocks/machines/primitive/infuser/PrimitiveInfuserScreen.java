...
public class PrimitiveInfuserScreen extends AbstractContainerScreen<PrimitiveInfuserContainer> {
    ...
    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(MechaniCraftMain.MODID, "textures/gui/infuser/primitive_metallic_infuser.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if(this.menu.isBurning()) {
            ...
            int burnRemaining = this.menu.getBurnScaled(BURN_METER_HEIGHT);
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        if(Screen.hasShiftDown()) {
            ...
            if (mouseX > (getGuiLeft() + INFO_PROGRESS_METER_TO_X) && mouseX < (getGuiLeft() + INFO_PROGRESS_METER_TO_X) + INFO_PROGRESS_METER_WIDTH && mouseY > (getGuiTop() + INFO_PROGRESS_METER_TO_Y) && mouseY < (getGuiTop() + INFO_PROGRESS_METER_TO_Y) + INFO_PROGRESS_METER_HEIGHT) {

                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(List.of(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.primitive_metallic_infuser.cook_progress", this.menu.getProgress(), this.menu.getMaxProgress()))), mouseX, mouseY);
            }

            if (mouseX > (getGuiLeft() + INFO_BURN_METER_TO_X) && mouseX < (getGuiLeft() + INFO_BURN_METER_TO_X) + INFO_BURN_METER_WIDTH && mouseY > (getGuiTop() + INFO_BURN_METER_TO_Y) && mouseY < (getGuiTop() + INFO_BURN_METER_TO_Y) + INFO_BURN_METER_HEIGHT) {

                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(List.of(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.primitive_metallic_infuser.burn_time", this.menu.getBurnTime(), this.menu.getMaxBurnTime()))), mouseX, mouseY);
            }
            ...
            if (mouseX > (getGuiLeft() + INFO_PROGRESS_METER_TO_X) && mouseX < (getGuiLeft() + INFO_PROGRESS_METER_TO_X) + INFO_PROGRESS_METER_WIDTH && mouseY > (getGuiTop() + INFO_PROGRESS_METER_TO_Y) && mouseY < (getGuiTop() + INFO_PROGRESS_METER_TO_Y) + INFO_PROGRESS_METER_HEIGHT) {
                ...
                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(Arrays.asList(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.primitive_metallic_infuser.cook_progress.no_shift", Utils.withSuffixTime(this.menu.getProgress()), Utils.withSuffixTime(this.menu.getMaxProgress())),
            ...
            if (mouseX > (getGuiLeft() + INFO_BURN_METER_TO_X) && mouseX < (getGuiLeft() + INFO_BURN_METER_TO_X) + INFO_BURN_METER_WIDTH && mouseY > (getGuiTop() + INFO_BURN_METER_TO_Y) && mouseY < (getGuiTop() + INFO_BURN_METER_TO_Y) + INFO_BURN_METER_HEIGHT) {
                ...
                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(Arrays.asList(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.primitive_metallic_infuser.burn_time.no_shift", Utils.withSuffixTime(this.menu.getBurnTime()), Utils.withSuffixTime(this.menu.getMaxBurnTime())),
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.gui_details"))), mouseX, mouseY);
            }
        }
    }
