...
public class AdvancedInfuserContainer extends AbstractContainerMenu {

    public final AdvancedInfuserBlockEntity infuserBE;
    private final Level level;

    public AdvancedInfuserContainer(int containerID, Inventory inv, FriendlyByteBuf extraData) {

        this(containerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public AdvancedInfuserContainer(int pContainerId, Inventory inv, BlockEntity entity) {

        super(MechaniCraftContainers.AdvancedInfuserCont.get(), pContainerId);
        checkContainerSize(inv, 4);
        infuserBE = (AdvancedInfuserBlockEntity) entity;
        ...
        if (infuserBE.getUpgradeInventory() != null) {
            ...
            this.addSlot(new SlotItemHandler(infuserBE.getUpgradeInventory(), 0, 153, 33));
        }
    }
    ...
    public boolean stillValid(Player player) {
        ...
        return stillValid(ContainerLevelAccess.create(level, infuserBE.getBlockPos()), player, MechaniCraftBlocks.AdvancedInfuser.get());
    }
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 5;  // 4 machine slots + 1 upgrade slot
    @Override
