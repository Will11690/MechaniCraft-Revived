...
public class PrimitiveInfuserContainer extends AbstractContainerMenu {
    ...
    public final PrimitiveInfuserBlockEntity infuserBE;
    ...
    public PrimitiveInfuserContainer(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        infuserBE = ((PrimitiveInfuserBlockEntity) entity);
        ...
        this.infuserBE.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(itemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(itemHandler, 0, 30, 20));  //input 1
            this.addSlot(new SlotItemHandler(itemHandler, 1, 58, 20));  //input 2
            this.addSlot(new SlotItemHandler(itemHandler, 2, 124, 35) { //output
            ...
            this.addSlot(new SlotItemHandler(itemHandler, 3, 44, 53));  //fuel
        });
