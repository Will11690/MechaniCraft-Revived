...
public class AdvancedInfuserBlockEntity extends BaseMachineBlockEntity implements IInfuserSync {

    private static final int BASE_CAPACITY = 153_600;
    ...
    public AdvancedInfuserBlockEntity(BlockPos pos, BlockState state) {

        // 1 upgrade slot at advanced tier
        super(MechaniCraftBlockEntities.AdvancedInfuserBE.get(), pos, state, true, BASE_CAPACITY, BASE_TRANSFER, true, 1);
    ...
    public void tickServer() {
        ...
        boolean wasLit = getBlockState().getValue(AdvancedInfuser.LIT);
        ...
        if (wasLit != workingThisTick) {
            ...
            level.setBlockAndUpdate(worldPosition, getBlockState().setValue(AdvancedInfuser.LIT, workingThisTick));
        }
    ...
    public @NotNull Component getDisplayName() {
        ...
        return MechaniCraftBlocks.AdvancedInfuser.get().getName();
    }

    @Override
    public @Nullable AbstractContainerMenu createMenu(int id, @NotNull Inventory inv, @NotNull Player player) {

        return new AdvancedInfuserContainer(id, inv, this);
    }
