...
public class UltimateInfuserBlockEntity extends BaseMachineBlockEntity implements IInfuserSync {

    private static final int BASE_CAPACITY = 384_000;
    private static final int BASE_TRANSFER = 1_280;
    ...
    public UltimateInfuserBlockEntity(BlockPos pos, BlockState state) {
        ...
        // 4 upgrade slots at ultimate tier
        super(MechaniCraftBlockEntities.UltimateInfuserBE.get(), pos, state, true, BASE_CAPACITY, BASE_TRANSFER, true, 4);
    ...
    public void tickServer() {
        ...
        boolean wasLit = getBlockState().getValue(UltimateInfuser.LIT);
        ...
        if (wasLit != workingThisTick) {
            ...
            level.setBlockAndUpdate(worldPosition, getBlockState().setValue(UltimateInfuser.LIT, workingThisTick));
        }
    ...
    public @NotNull Component getDisplayName() {
        ...
        return MechaniCraftBlocks.UltimateInfuser.get().getName();
    }

    @Override
    public @Nullable AbstractContainerMenu createMenu(int id, @NotNull Inventory inv, @NotNull Player player) {

        return new UltimateInfuserContainer(id, inv, this);
    }
