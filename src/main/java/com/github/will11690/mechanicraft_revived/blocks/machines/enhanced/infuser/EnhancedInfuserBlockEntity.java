...
public class EnhancedInfuserBlockEntity extends BaseMachineBlockEntity implements IInfuserSync {

    private static final int BASE_CAPACITY = 76_800;
    private static final int BASE_TRANSFER = 256;
    ...
    public EnhancedInfuserBlockEntity(BlockPos pos, BlockState state) {

        super(MechaniCraftBlockEntities.EnhancedInfuserBE.get(), pos, state, true, BASE_CAPACITY, BASE_TRANSFER, true, 0);
    ...
    public void tickServer() {
        ...
        boolean wasLit = getBlockState().getValue(EnhancedInfuser.LIT);
        ...
        if (wasLit != workingThisTick) {
            ...
            level.setBlockAndUpdate(worldPosition, getBlockState().setValue(EnhancedInfuser.LIT, workingThisTick));
        }
    ...
    public @NotNull Component getDisplayName() {
        ...
        return MechaniCraftBlocks.EnhancedInfuser.get().getName();
    }

    @Override
    public @Nullable AbstractContainerMenu createMenu(int id, @NotNull Inventory inv, @NotNull Player player) {

        return new EnhancedInfuserContainer(id, inv, this);
    }
