...
public class SuperiorInfuserScreen extends AbstractContainerScreen<SuperiorInfuserContainer> {

    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(MechaniCraftMain.MODID, "textures/gui/infuser/superior_metallic_infuser.png");
    ...
    public SuperiorInfuserScreen(SuperiorInfuserContainer menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        if (mouseX > (getGuiLeft() + INFO_PROGRESS_METER_TO_X) && mouseX < (getGuiLeft() + INFO_PROGRESS_METER_TO_X) + INFO_PROGRESS_METER_WIDTH &&
            ...
            if (Screen.hasShiftDown()) {
                ...
                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(List.of(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.superior_metallic_infuser.cook_progress",
                ...
                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(Arrays.asList(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.superior_metallic_infuser.cook_progress", Utils.withSuffixTime(this.menu.getProgress()), Utils.withSuffixTime(this.menu.getMaxProgress())),
        ...
        if (isHovering(energyX, energyY, energyW, energyH, mouseX, mouseY)) {
            ...
            if (Screen.hasShiftDown()) {
                ...
                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(List.of(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.superior_metallic_infuser.energy",
                                this.menu.getEnergyStored(), this.menu.getEnergyCapacity()))), mouseX, mouseY);
            } else {

                guiGraphics.renderTooltip(this.font, Language.getInstance().getVisualOrder(Arrays.asList(
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.superior_metallic_infuser.energy", Utils.withSuffixEnergy(this.menu.getEnergyStored()), Utils.withSuffixEnergy(this.menu.getEnergyCapacity())),
                        Component.translatable("com.github.will11690.mechanicraft_revived.screen.gui_details"))), mouseX, mouseY);
            }
        }
    }
